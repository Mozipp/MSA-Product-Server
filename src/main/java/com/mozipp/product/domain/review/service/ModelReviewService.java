...
public class ModelReviewService {
    ...
    @Transactional
    public void createModelReview(ModelReviewCreateDto request, Model model) {
        ...
        Review review = ReviewConverter.toModelReview(request, model, designerProduct, designerId);
